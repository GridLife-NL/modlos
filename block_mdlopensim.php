...
class block_mdlopensim extends block_base 
{
	...
	function get_content()
	{
		...
		$this->content->text = '<a href="'.MDLOPNSM_BLK_URL.'/world_map.php?course='.$id.'">'.get_string('mdlos_world_map','block_mdlopensim').'</a><br />';
		$this->content->text.= '<a href="'.MDLOPNSM_BLK_URL.'/regions_list.php?course='.$id.'">'.get_string('mdlos_regions_list','block_mdlopensim').'</a><br />';
		if (!isguest()) {
			$this->content->text.= '<a href="'.MDLOPNSM_BLK_URL.'/avatars_list.php?course='.$id.'">'.get_string('mdlos_avatars_list','block_mdlopensim').'</a><br />';
			$this->content->text.= '<a href="'.MDLOPNSM_BLK_URL.'/avatar_make.php?course='.$id.'">'.get_string('mdlos_avatar_make','block_mdlopensim').'</a><br />';
/*
			if (isadmin()) {
