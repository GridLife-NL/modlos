...
if ($get_action=='all') $regions = new RegionsList($course_id, $instance_id, true);
else                    $regions = new RegionsList($course_id, $instance_id, false, $user_id);

print_tabnav($tab_action, $course_id, $instance_id, !$regions->isAvatarMax);
