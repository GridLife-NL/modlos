...
if (OSPROFILE_DB=='HELPER') {
	...
	define('PROFILE_USERPICKS_TBL',  	PREFIX.PROFILE_USERPICKS_TBL_BASE);
	define('PROFILE_USERPROFILE_TBL',  	PREFIX.PROFILE_USERPROFILE_TBL_BASE);
	define('PROFILE_USERSETTINGS_TBL',	PREFIX.PROFILE_USERSETTINGS_TBL_BASE);
}
